...
//if (!$CheckFile) {
   // $createFile = $main->createFile($filename);
    ...
    //BEGIN
    $SQL = "SELECT a.ID, a.RESPONSE FROM app_log_services a WHERE a.METHOD in ('GetImporPermit','GetImpor_Sppb','GetImporPermit_FASP')  AND a.FL_USED = '0' order by a.WK_REKAM ASC limit 5";
