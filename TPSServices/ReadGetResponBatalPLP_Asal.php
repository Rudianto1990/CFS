...
if (!$CheckFile) {
    ...
    //BEGIN
	$SQL = "SELECT a.ID, a.RESPONSE FROM app_log_services a WHERE a.METHOD in ('GetResponBatalPLP','ReceiveResponBatalPLP') AND a.FL_USED='0' AND a.RESPONSE is not null order by a.WK_REKAM ASC limit 10";
...
function InsertKemasan($ID, $CONT, $CFS="") {
    ...
    $SQL = "INSERT INTO t_respon_batal_plp_asal_kms (ID, KD_KEMASAN, JML_KMS, NO_BL_AWB, TGL_BL_AWB, KD_STATUS)
