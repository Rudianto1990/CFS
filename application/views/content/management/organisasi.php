        ...
        <div class="tab-pane p-x-lg active" id="tab1">
          <form name="form_data" id="form_data" class="form-horizontal" role="form" action="<?php echo site_url('management/execute/'.$act.'/organisasi/'.$ID); ?>" method="post" autocomplete="off" onsubmit="save_popup('form_data','divtblorganisasi'); return false;">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="DATA[EMAIL]" id="EMAIL" wajib="yes" class="form-control email" placeholder="EMAIL" value="<?php echo $arrhdr['EMAIL']; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label-left">JENIS ORGANISASI</label>
              <div class="col-sm-10">
                <select name="DATA[JENIS_ORGANISASI]" id="JENIS_ORGANISASI" wajib="yes" class="form-control">
				<option></option>
