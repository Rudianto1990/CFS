			...
			<table>
				<tr>
					<td>
						...
						<table>
							<tr class="black">
								<td width="660px"><h1 style="color:white; font-weight:bold">PROFORMA INVOICE PELAYANAN JASA : LCL CARGO</h1></td>
							</tr>
						</table>
						...
						<table>
							...
							<tr>
							  ...
							  <th style="width:10px"><h1>:</h1></th>
							  <th style="width:120px"><h1 style="font-size: 10px;font-weight:bold">'.$data['CONSIGNEE'].'</h1></th>
							  <th style="width:50px"><h1></h1></th>
							...
							<tr>
							  ...
							  <th style="width:10px"><h1>:</h1></th>
							  <th style="width:120px"><h1 style="font-size: 10px;font-weight:bold">'.$data['NPWP_CONSIGNEE'].'</h1></th>
							  <th style="width:50px"><h1></h1></th>
							  <th style="width:80px"><h1></h1></th>
							  <th style="width:10px"><h1></h1></th>
							...
							<tr>
							  ...
							  <th style="width:10px;vertical-align:top"><h1>:</h1></th>
							  <th style="width:120px;vertical-align:top" colspan=5><h1 style="font-size: 10px;font-weight:bold">'.$data['ALAMAT_CONSIGNEE'].'</h1></th>
							</tr>
							<tr>
							  <th style="width:80px"><h1></h1></th>
							  <th style="width:10px"><h1></h1></th>
